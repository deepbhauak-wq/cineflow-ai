...
export default function CineFlowStudio() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-indigo-500 selection:text-white">
      ...
      {/* Professional Quick Action Bar */}
      <div className="flex items-center gap-3 px-6 py-3 border-b border-slate-800/80 bg-slate-900/40 text-xs">
        <button className="flex items-center gap-2 bg-slate-800 hover:bg-slate-700 text-slate-200 px-3.5 py-1.5 rounded-lg font-medium border border-slate-700 transition active:scale-95">
          <Play className="w-3.5 h-3.5" /> Live Preview
        </button>
        <button className="flex items-center gap-2 bg-emerald-600/10 hover:bg-emerald-600/20 text-emerald-400 px-3.5 py-1.5 rounded-lg font-medium border border-emerald-500/30 transition active:scale-95">
          <Cpu className="w-3.5 h-3.5" /> Render Project
        </button>
        <div className="ml-auto flex items-center gap-2">
          <button className="p-1.5 bg-slate-800 hover:bg-slate-700 rounded-lg border border-slate-700 text-slate-300 transition">
