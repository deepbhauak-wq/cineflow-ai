    ...
    <div className="min-h-screen bg-[#07090e] text-white p-4 font-sans pb-28 relative">
      ...
      <div className="max-w-4xl mx-auto flex items-center justify-between border-b border-slate-800 pb-3 mb-4">
        <div>
          ...
          <p className="text-[10px] text-slate-400">100% Strict Visual, Face, Voice & Outfit Persistence</p>
        </div>
        <div className="flex gap-2">
          <button onClick={handleAdd} className="px-3 py-1 rounded-xl bg-cyan-500 text-black text-xs font-bold shadow">+ Add</button>
      ...
      <div className="max-w-4xl mx-auto space-y-4">
        ...
        <div className="flex justify-end">
          <button onClick={() => handleDelete(activeChar.id)} className="px-3 py-1.5 rounded-xl bg-red-500/10 border border-red-500/30 text-red-400 text-xs">🗑️ Delete Character</button>
        </div>
      </div>
