    ...
    <div className="min-h-screen bg-[#07090e] text-white p-4 font-sans pb-28 relative">
      ...
      <div className="max-w-4xl mx-auto space-y-4">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 space-y-2">
          ...
          <label className="px-3 py-1.5 rounded-lg bg-slate-800 border border-slate-700 text-[11px] text-cyan-300 cursor-pointer inline-flex items-center gap-1.5">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 space-y-2">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
            {styleCatalog.map((s) => (
              <div key={s.name} onClick={() => setVisualStyle(s.name)} className={`rounded-xl overflow-hidden border cursor-pointer ${visualStyle === s.name ? "border-cyan-400 ring-2 ring-cyan-500/30" : "border-slate-800"}`}>
