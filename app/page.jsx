    ...
    <div className="min-h-screen bg-[#070b14] text-white flex items-center justify-center p-4 font-sans select-none">
      <div className="w-full max-w-sm bg-[#0b1222] p-6 rounded-3xl border border-slate-800 space-y-4 shadow-2xl">
        ...
        <div className="space-y-3">
          ...
          <button onClick={() => router.push("/")} className="w-full py-2.5 bg-[#1877F2]/10 border border-[#1877F2]/40 rounded-xl text-xs font-bold text-blue-400 transition active:scale-95">
            🔵 Continue with Facebook
          </button>
          <button onClick={() => router.push("/")} className="w-full py-2.5 bg-pink-500/10 border border-pink-500/30 rounded-xl text-xs font-bold text-pink-300 transition active:scale-95">
