                  ...
                  {editingSceneId === sc.id ? (
                    <div className="space-y-2 bg-[#060a14] p-3 rounded-xl border border-cyan-500/50">
                      ...
                      <textarea
                        ...
                        rows={2}
                        className="w-full bg-[#0b1222] border border-slate-700 rounded-lg p-2 text-xs text-white outline-none"
                      />
                      ...
                      <div className="grid grid-cols-2 gap-2 pt-1">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full bg-[#0b1222] border border-slate-700 rounded-lg p-1.5 text-xs text-white outline-none"
                          />
                        </div>
                        <div>
                          <label className="text-[9px] text-slate-400 font-bold uppercase block">
                      ...
                      <div className="flex gap-2 pt-2">
                        <button
                          ...
                          className="flex-1 py-2 rounded-lg bg-emerald-600 text-white text-[10px] font-black uppercase active:scale-95"
                        >
                          💾 Save & Re-render Scene
                        </button>
                        <button
                          onClick={() => setEditingSceneId(null)}
                          className="px-3 py-2 rounded-lg bg-slate-800 text-slate-400 text-[10px] font-bold"
                        >
                          Cancel
                        </button>
                      </div>
                    ...
                    <>
                      ...
                      <div className="flex gap-2 pt-1">
                        ...
                        <button
                          ...
                          className="px-4 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-[10px] font-bold active:scale-95 cursor-pointer flex items-center gap-1"
                        >
                          ✏️ Edit Prompt
                        </button>
                      </div>
