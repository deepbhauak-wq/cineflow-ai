          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 space-y-2">
            ...
            <div className="grid grid-cols-3 gap-2">
              {["16:9", "9:16", "21:9", "4:3", "1:1", "Auto"].map((r) => (
                <button key={r} onClick={() => setAspectRatio(r)} className={`py-2 rounded-xl border text-xs cursor-pointer ${aspectRatio === r ? "bg-cyan-500/20 border-cyan-500 text-cyan-300 font-bold" : "bg-slate-800 border-slate-700 text-slate-400"}`}>{r}</button>
              ))}
            </div>
          </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              {["3 Min (18 Scenes)", "15 Min (90 Scenes)", "30 Min (180 Scenes)", "60 Min (360 Scenes)"].map((t) => (
                <button key={t} onClick={() => setDuration(t)} className={`py-2 px-1 rounded-xl border text-[11px] cursor-pointer ${duration === t ? "bg-purple-500/20 border-purple-500 text-purple-300 font-bold" : "bg-slate-800 border-slate-700 text-slate-400"}`}>{t}</button>
              ))}
            </div>
          </div>
        </div>
